...
else
{
	...
	header("location:r.php?msg=Enter valid Name.");
}
...
else
{
	...
	header("location:r.php?msg=Enter valid Username :min 3 Chars.");
...
else
{
	...
	header("location:r.php?msg=Enter valid Email Id.");
}
...
else
{
	...
	header("location:r.php?msg=Enter valid Password: min 3 Chars.");
}
...
if(strcmp($password,$repassword))
		...
		header("location:r.php?msg=Password and Repassword are not same");
// Gender
if (strcmp($gender,"")==0)
{
	//$msg='Select Gender';
	header("location:r.php?msg=Select Gender");
}
else
{
$valid_gender=$gender;
...
if (strcmp($privilege,"")==0)
{
	...
	header("location:r.php?msg=Please select one");
}
else
{
